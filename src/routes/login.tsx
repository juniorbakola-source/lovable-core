...
export const Route = createFileRoute("/login")({
  head: () => ({ meta: [{ title: "Sign in — FlowStock Pro" }] }),
  component: Login,
});
    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      <div className="hidden lg:flex bg-sidebar text-sidebar-foreground p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative">
          <h2 className="text-4xl font-bold mb-4 leading-tight">Smarter inventory.<br/>Less waste.</h2>
          <p className="text-sidebar-foreground/70 text-lg max-w-md">Join teams running lean with science-backed reorder decisions.</p>
        </div>
      ...
      <div className="flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-sm">
          ...
          <p className="text-muted-foreground mb-8">Welcome back to FlowStock Pro.</p>
