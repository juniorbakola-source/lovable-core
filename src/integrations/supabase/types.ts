  ...
  public: {
    Tables: {
      ...
      sku_change_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "sku_change_history_sku_id_fkey"
            columns: ["sku_id"]
            isOneToOne: false
            referencedRelation: "skus"
            referencedColumns: ["id"]
      ...
      silvery_engine_results: {
        ...
        Relationships: [
          {
            foreignKeyName: "silvery_engine_results_run_id_fkey"
            columns: ["run_id"]
            isOneToOne: false
            referencedRelation: "silvery_engine_runs"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "silvery_engine_results_sku_id_fkey"
            columns: ["sku_id"]
            isOneToOne: false
            referencedRelation: "skus"
            referencedColumns: ["id"]
